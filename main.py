    ...
    for match in matchCollection:
        ...
        for item in zin.infolist():
            ...
            if item.filename == 'word/document.xml':
                ...
                res = res.replace('NHAN DAO', match[MENTOR]['name'].upper())
                res = res.replace('Nhandao2020@gmail.com', match[MENTOR]['email'])
                res = res.replace('(209) 629-0912', '') # Mentors dont have phone numbers yet
                ...
                res = res.replace('Tien Le', match[MENTEE]['name'])
        ...
        for item in zin.infolist():
            ...
            if item.filename == 'word/document.xml':
                ...
                res = res.replace('NHAN DAO', match[MENTEE]['name'].upper())
                res = res.replace('Nhandao2020@gmail.com', match[MENTEE]['email'])
                res = res.replace('(209) 629-0912', str(match[MENTEE]['phone_number']))
                ...
                res = res.replace('Tien Le', match[MENTOR]['name'])
                buffer = res.encode('utf-8')
